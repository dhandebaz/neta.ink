  ...
  return (
    <main className="space-y-8">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">Data we collect</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">How data is stored</h2>
        <p className="max-w-3xl text-sm text-slate-300">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">How data is used</h2>
        <p className="max-w-3xl text-sm text-slate-300">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">Sharing</h2>
        <p className="max-w-3xl text-sm text-slate-300">
      ...
      <section className="space-y-2">
        ...
        <p className="max-w-3xl text-sm text-slate-300">
          ...
          neta team at{" "}
          <a href={`mailto:${contactEmail}`} className="text-amber-300 hover:underline">
            {contactEmail}
          </a>
          .
        </p>
