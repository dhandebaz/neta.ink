    ...
    <main className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-6xl space-y-6">
        <header className="space-y-3">
          <h1 className="text-3xl font-bold text-slate-50">Delhi Politicians</h1>
          <p className="text-sm text-slate-300">
            All MLAs and MPs for Delhi from the current seed, with basic details on constituencies, parties,
            cases and ratings.
          </p>
          <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm">
            <span className="text-slate-400">Filter by position:</span>
            <Link
            ...
            <Link
              ...
              className={`rounded-full border px-3 py-1 ${
                filterPosition === "MLA"
                  ...
                  : "border-slate-700 bg-slate-900 text-slate-200 hover:border-emerald-400/70"
              }`}
            >
              MLAs
            </Link>
            <Link
              ...
              className={`rounded-full border px-3 py-1 ${
                filterPosition === "MP"
                  ...
                  : "border-slate-700 bg-slate-900 text-slate-200 hover:border-indigo-400/70"
              }`}
            >
              MPs
            </Link>
        ...
        {hadError ? (
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-950/80">
            <div className="border-b border-slate-800/80 bg-slate-900/80 px-4 py-3 text-left text-xs text-slate-300">
              <span className="font-semibold text-slate-100">Directory</span>
