  ...
  return (
    <main className="space-y-8">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">Acceptance</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">Service description</h2>
        <p className="max-w-3xl text-sm text-slate-300">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">No guarantees</h2>
        <p className="max-w-3xl text-sm text-slate-300">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">Responsibility</h2>
        <p className="max-w-3xl text-sm text-slate-300">
      ...
      <section className="space-y-2">
        <h2 className="text-lg font-semibold text-slate-50">Payments</h2>
        <p className="max-w-3xl text-sm text-slate-300">
