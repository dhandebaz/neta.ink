  ...
  return (
    <main className="space-y-8">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-50">What is neta?</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-50">What neta does technically</h2>
        <p className="max-w-3xl text-sm text-slate-600 dark:text-slate-300">
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-50">State coverage roadmap</h2>
        <p className="max-w-3xl text-sm text-slate-600 dark:text-slate-300">
